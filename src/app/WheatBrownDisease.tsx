...
const WheatBrownDisease = () => {
    ...
    const images = [
        require("../assets/images/Wheatbrownrust.jpg"),
        require("../assets/images/Wheatbrownrust1.jpg"),
        require("../assets/images/Wheatbrownrust2.jpg"),
        require("../assets/images/Wheatbrownrust3.jpg"),
        require("../assets/images/Wheatbrownrust4.jpg"),
        require("../assets/images/Wheatbrownrust5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Wheat Brown Rust </Text>
                </View>
...
export default WheatBrownDisease;
