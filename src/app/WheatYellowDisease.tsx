...
const WheatYellowDisease = () => {
    ...
    const images = [
        require("../assets/images/Wheatyellowrust.jpg"),
        require("../assets/images/Wheatyellowrust1.jpg"),
        require("../assets/images/Wheatyellowrust2.jpg"),
        require("../assets/images/Wheatyellowrust3.jpg"),
        require("../assets/images/Wheatyellowrust4.jpg"),
        require("../assets/images/Wheatyellowrust5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Wheat Yellow Rust</Text>
                </View>
...
export default WheatYellowDisease;
