...
const RiceHealthyDisease = () => {
    ...
    const images = [
        require("../assets/images/Ricehealthy1.jpg"),
        require("../assets/images/Ricehealthy2.jpg"),
        require("../assets/images/Ricehealthy3.jpg"),
        require("../assets/images/Ricehealthy4.jpg"),
        require("../assets/images/Ricehealthy5.jpg"),
        require("../assets/images/Ricehealthy6.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Rice Healthy</Text>
                </View>
...
export default RiceHealthyDisease;
