...
const CornBelightDisease = () => {
    ...
    const images = [
        require("../assets/images/Corn_Blight.jpg"),
        require("../assets/images/Corn_Blight1.jpg"),
        require("../assets/images/Corn_Blight2.jpg"),
        require("../assets/images/Corn_Blight3.jpg"),
        require("../assets/images/Corn_Blight4.jpg"),
        require("../assets/images/Corn_Blight5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Corn Blight</Text>
                </View>
...
export default CornBelightDisease;
