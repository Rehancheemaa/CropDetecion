...
const RiceGrayLeafDisease = () => {
    ...
    const images = [
        require("../assets/images/riceleafblast.jpg"),
        require("../assets/images/riceleafblast1.jpg"),
        require("../assets/images/riceleafblast2.jpg"),
        require("../assets/images/riceleafblast3.jpg"),
        require("../assets/images/riceleafblast4.jpg"),
        require("../assets/images/riceleafblast5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Rice Gray Leaf</Text>
                </View>
...
export default RiceGrayLeafDisease;
