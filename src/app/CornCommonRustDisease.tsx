...
const CornCommonRustDisease = () => {
    ...
    const images = [
        require("../assets/images/Corn_Common_Rust.jpg"),
        require("../assets/images/Corn_Common_Rust1.jpg"),
        require("../assets/images/Corn_Common_Rust2.jpg"),
        require("../assets/images/Corn_Common_Rust3.jpg"),
        require("../assets/images/Corn_Common_Rust4.jpg"),
        require("../assets/images/Corn_Common_Rust5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Corn Common Rust</Text>
                </View>
...
export default CornCommonRustDisease;
