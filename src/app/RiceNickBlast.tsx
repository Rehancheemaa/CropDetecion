...
const RiceNickBlast = () => {
    ...
    const images = [
        require("../assets/images/Ricenickblast.jpg"),
        require("../assets/images/Ricenickblast1.jpg"),
        require("../assets/images/Ricenickblast2.jpg"),
        require("../assets/images/Ricenickblast3.jpg"),
        require("../assets/images/Ricenickblast4.jpg"),
        require("../assets/images/Ricenickblast5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Rice Nick Blast</Text>
                </View>
