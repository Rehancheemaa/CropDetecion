...
const WheatHealthyDisease = () => {
    ...
    const images = [
        require("../assets/images/Wheathealthy.jpg"),
        require("../assets/images/Wheathealthy1.jpg"),
        require("../assets/images/Wheathealthy2.jpg"),
        require("../assets/images/Wheathealthy3.jpg"),
        require("../assets/images/Wheathealthy4.jpg"),
        require("../assets/images/Wheathealthy5.jpg"),
    ];
        ...
        >
            <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0.4)']} style={styles.overlay}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>Wheat Healthy </Text>
                </View>
...
export default WheatHealthyDisease;
